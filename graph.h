...
class Graph
{
    private :
        ...
        std::map<int, Edge> m_edges;
            std::map<int, Edge> m_edgeseffacer;

        /// La liste des sommets
        std::map<int, Vertex> m_vertices;
          std::map<int, Vertex> m_vertexeffacer;
    ...
    public:
        ...
        void add_interfaced_vertex(int idx, double value, int x, int y, std::string pic_name="", int pic_idx=0 );
         void add_interfaced_vertex2(int idx, double value, int x, int y, std::string pic_name="", int pic_idx=0 );
        ...
        void make_example(std::string f1,std::string f2);
        void save(std::string f1);
        void simulation();
        void effaSommet(int vidx,std::string f3);
        void ajouter(int index, std::string f3);
        void effaceArrete(int index);
        void ajoutearrete(int index);
       // void ajouterfichier();


        /// La méthode update à appeler dans la boucle de jeu pour les graphes avec interface
        void update(std::string f3);
        void menuefface(std::string f3);
        void menuajoute(std::string f3);
};
